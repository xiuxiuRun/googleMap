...
if(session.getAttribute("Latitude")==null){
	session.setAttribute("Latitude",112.91798f);
}
...
if(neweLongitude>25.52f){
	try{
		File tofile=new File("C:/Users/dell2/Desktop/googleLog/15/right.txt");
...
<html>
  ...
  function initialize() {
    ...
    if(parseFloat(newLatitudeT) > parseFloat(113.293)){
    	alert("out of border");
    	alert("右边已经下载完毕");
    }
